...
ALTER TABLE "ballots" ADD CONSTRAINT "ballots_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "ballots" ADD CONSTRAINT "ballots_nominee_id_nominees_id_fk" FOREIGN KEY ("nominee_id") REFERENCES "nominees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "watchlist" ADD CONSTRAINT "watchlist_nominee_id_nominees_id_fk" FOREIGN KEY ("nominee_id") REFERENCES "nominees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
